  ...
  { -- Adds git related signs to the gutter, as well as utilities for managing changes
    ...
    opts = function(_, opts)
      ...
      opts.on_attach = function(bufnr)
        ...
        map("n", "<leader>gbs", gitsigns.stage_buffer, { desc = "Buffer Stage" })
        map("n", "<leader>gbr", gitsigns.reset_buffer, { desc = "Buffer Reset" })
        ...
        -- Toggles
        map("n", "<leader>gbl", gitsigns.toggle_current_line_blame, { desc = "Blame Line" })
        map("n", "<leader>gds", gitsigns.toggle_deleted, { desc = "Deleted Show" })
      end
    end,
  },
}
